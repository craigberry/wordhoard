...
CREATE TABLE pos (
  ...
  MAJORCLASS varchar(255) default NULL,
  WORDCLASS varchar(255) default NULL,
  compound_tag varchar(255) default NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE english (
  ...
  OldNUPOS varchar(255) default NULL,
  ...
  lemPos varchar(255) default NULL,
  morphid varchar(255) default NULL,
  plainLemma varchar(255) default NULL,
  NUPOS varchar(255) default NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
