...
public class UseElementNameRule implements WorkPartTitleRule {
	 ...
	 *
	 *	@param	el		UseElementName element.
	 */

	public UseElementNameRule (Element el) {
		Utils.checkAttributeNames(el, new String[] {"capitalizeFirstLetter"});
