 ...
 *
 *	<p>Makes sure the author is "William Shakespeare".
 */

public class ShaAuthor extends Fixer {
		...
		throws Exception
	{
		...
		if (author.equals("William Shakespeare")) return;
		DOMUtils.setText(authorEl, "William Shakespeare");
		log("ShaAuthor", "Author changed to 'William Shakespeare'");
	}
