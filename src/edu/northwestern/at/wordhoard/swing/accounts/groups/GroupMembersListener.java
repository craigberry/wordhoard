...
/**	An group listener.
 *
 *	<p>The listener interface for receiving group model state change 
 *	events. See
 *	{@link edu.northwestern.at.wordhoard.swing.accounts.groups.GroupMembersModel
 *	GroupMembersModel} for details.
 */
...
interface GroupMembersListener {
	 ...
	 *
	 *	@param	index			Index of group to be selected.
	 */
