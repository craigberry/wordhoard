...
public	 class DocFreqCriterion extends CriterionComponent {
...
/*		panel.add(new JLabel("between"));
	...
	String updateCriteria () {
		...
		if (freq == null) {docFrequency=null;}
		else {
			docFrequency=new DocFrequency(freq, compare,corpus);
		}
		return null;
	}
	...
	String setCriteria (SearchCriteria searchCriteria) {
		...
		if(reply==null) searchCriteria.add(docFrequency);
		return reply;
	}
