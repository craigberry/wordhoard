 ...
 *
 *	<p>
 *	DocumentTokenizer implements the Iterator interface, but the
 ...
 *	<p>
 *	<code>
 *		// Tokenize a document and print out list of words.
 *		// Start at position 0 (the beginning of the document).
 *		// Get the document from a JTextPane.
 *
 *			Document document = textPane.getDocument();
 *
 *			DocumentTokenizer tokenizer =
 *				new DocumentTokenizer( document , 0 );
 *
	...
	implements Iterator
{
	 ...
	 *	@param	offset		Offset in document to start at.
	 */

	public DocumentTokenizer( Document document , int offset )
	{
